...
Cypress.Commands.add(
  'createTodo',
  (title = 'Test Todo', description = 'This is a test todo description') => {
    cy.request({
      method: 'POST',
      url: '/api/v1/todos',
      body: {
...
Cypress.Commands.add(
  'createProject',
  (name = 'Test Project', description = 'This is a test project description') => {
    cy.request({
      method: 'POST',
      url: '/api/v1/projects',
      body: {
...
Cypress.Commands.add(
  'testApiError',
  (method: string, url: string, body: any, expectedStatus: number) => {
    cy.request({
      method,
      url,
      body,
